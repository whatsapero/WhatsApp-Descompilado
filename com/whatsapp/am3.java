...
class am3 extends AsyncTask {
    long a;
    final float b;
    final float c;
    final int d;
    final VideoTimelineView e;

    protected void onPostExecute(Object obj) {
        a((Void) obj);
    }

    am3(VideoTimelineView videoTimelineView, float f, float f2, int i) {
    ...
    protected void a(Bitmap[] bitmapArr) {
        ...
        int i2 = 0;
        while (i2 < length) {
            VideoTimelineView.c(this.e).add(bitmapArr[i2]);
            i2++;
            if (i != 0) {
                break;
            }
    ...
    protected java.lang.Void a(java.lang.Void[] r15) {
        ...
        r4.<init>();
        r0 = r14.e;
        r0 = com.whatsapp.VideoTimelineView.b(r0);
    ...
    L_0x0062:
        ...
        r11 = r14.c;	 Catch:{ Exception -> 0x00bf }
        r1 = (r1 > r11 ? 1 : (r1 == r11 ? 0 : -1));
        if (r1 <= 0) goto L_0x00c9;
    L_0x0069:
        r1 = r14.b;
    ...
    L_0x009a:
        ...
        r9.<init>(r1);
        r10 = r14.e;
        r10 = com.whatsapp.VideoTimelineView.a(r10);
    ...
    L_0x00c9:
        ...
        goto L_0x00a8;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.am3.a(java.lang.Void[]):java.lang.Void");
    }
