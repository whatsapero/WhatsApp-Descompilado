...
public class SlidingPaneLayout extends ViewGroup {
    ...
    class DragHelperCallback extends Callback {
        ...
        DragHelperCallback(SlidingPaneLayout slidingPaneLayout, AnonymousClass_1 anonymousClass_1) {
        ...
        public boolean tryCaptureView(View view, int i) {
            return SlidingPaneLayout.access$100(this.this$0) ? false : ((LayoutParams) view.getLayoutParams()).slideable;
        }
    ...
    class SlidingPanelLayoutImplJB extends SlidingPanelLayoutImplBase {
        ...
        static {
            ...
            String str = "\u0000s[McesLDc rAK\u007f\"!MKb5mH[1)hZV16uHVt";
            Object obj = -1;
            ...
            while (true) {
                ...
                switch (obj) {
                    case PBE.MD5 /*0*/:
                        strArr2[i] = str;
                        str = "\u0006n\\Nu+&]\u0002w uJJ1\"d]fx6qECh\thZV1(d]J~!:\tFx(l@LvevFL61!^Mc.![Kv-u\u0007";
                        i = 2;
                        strArr2 = strArr3;
                        obj = 1;
                        break;
                    ...
                    case aj.i /*4*/:
                        strArr2[i] = str;
                        i = 6;
                        str = "\u0006n\\Nu+&]\u0002w uJJ1(SLAc `]GU,rYNp<M@Qeeg@G}!:\tFx(l@Lvev@N}ecL\u0002b)n^\f";
                        obj = 5;
                        strArr2 = strArr3;
                        break;
                    case aV.r /*5*/:
        ...
        SlidingPanelLayoutImplJB() {
            try {
                this.mGetDisplayList = View.class.getDeclaredMethod(z[5], (Class[]) null);
            } catch (Throwable e) {
                Log.e(z[3], z[2], e);
            }
            try {
    ...
    public void requestChildFocus(android.view.View r2, android.view.View r3) {
        /*
        r1_this = this;
        super.requestChildFocus(r2, r3);	 Catch:{ IllegalStateException -> 0x0015 }
        r0 = r1.isInTouchMode();	 Catch:{ IllegalStateException -> 0x0015 }
        if (r0 != 0) goto L_0x0014;
    L_0x0009:
        r0 = r1.mCanSlide;	 Catch:{ IllegalStateException -> 0x0017 }
        if (r0 != 0) goto L_0x0014;
    L_0x000d:
        r0 = r1.mSlideableView;	 Catch:{ IllegalStateException -> 0x0019 }
    ...
    L_0x001b:
        ...
        goto L_0x0012;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.widget.SlidingPaneLayout.requestChildFocus(android.view.View, android.view.View):void");
    }
    ...
    L_0x001b:
        ...
        r1 = a;	 Catch:{ IllegalStateException -> 0x0068 }
    ...
    L_0x0004:
        ...
        r2 = r3.mCanSlide;	 Catch:{ IllegalStateException -> 0x001c }
        if (r2 == 0) goto L_0x0022;
    L_0x000e:
        r0 = r0.dimWhenOffset;	 Catch:{ IllegalStateException -> 0x001e }
        if (r0 == 0) goto L_0x0022;
    L_0x0012:
        r0 = r3.mSlideOffset;	 Catch:{ IllegalStateException -> 0x0020 }
        r2 = 0;
    ...
    L_0x0022:
        ...
        goto L_0x001a;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.widget.SlidingPaneLayout.isDimmed(android.view.View):boolean");
    }
    ...
    static {
        ...
        String str = "<mGM\u001aKiVJ\u0006KlBO\u0017KeM\u0019\u0017\u0013e@MR\u001deOL\u0017KkQ\u0019?*P`q-;Eq|<?";
        Object obj = -1;
        String[] strArr2 = strArr;
        String[] strArr3 = strArr;
        int i = 0;
        while (true) {
            ...
            switch (obj) {
                case PBE.MD5 /*0*/:
                    strArr2[i] = str;
                    str = "\u0004jn\\\u0013\u0018qQ\\HKILK\u0017KpKX\u001cKpTVR\blJU\u0016KrJ\\\u0005\u0018$BK\u0017KjLMR\u0018qSI\u001d\u0019pF]\\";
                    i = 2;
                    strArr2 = strArr3;
                    obj = 1;
                    break;
                ...
                case ay.p /*3*/:
                    ...
                    i = 5;
                    strArr2 = strArr3;
                    str = "KvFM\u0007\u0019jF]R\u0005qOUR\u000fvBN\u001b\u0005c\u0003Z\u0013\blF";
                    obj = 4;
                    break;
                case aj.i /*4*/:
                    strArr2[i] = str;
                    i = 6;
                    str = "\u000fvBN1\u0003mO]HKgKP\u001e\u000f$UP\u0017\u001c$";
                    obj = 5;
                    strArr2 = strArr3;
                    break;
                case aV.r /*5*/:
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void dimChildView(android.view.View r7, float r8, int r9) {
        /*
        r6_this = this;
        r5 = 2;
    ...
    L_0x000e:
        ...
        r2 = r2 & r9;
        r1 = r1 | r2;
        r2 = r0.dimPaint;	 Catch:{ IllegalStateException -> 0x0065 }
        if (r2 != 0) goto L_0x0028;
    L_0x0021:
        r2 = new android.graphics.Paint;	 Catch:{ IllegalStateException -> 0x0065 }
        r2.<init>();	 Catch:{ IllegalStateException -> 0x0065 }
        r0.dimPaint = r2;	 Catch:{ IllegalStateException -> 0x0065 }
    L_0x0028:
        r2 = r0.dimPaint;	 Catch:{ IllegalStateException -> 0x0067 }
        r3 = new android.graphics.PorterDuffColorFilter;	 Catch:{ IllegalStateException -> 0x0067 }
        r4 = android.graphics.PorterDuff.Mode.SRC_OVER;	 Catch:{ IllegalStateException -> 0x0067 }
        r3.<init>(r1, r4);	 Catch:{ IllegalStateException -> 0x0067 }
        r2.setColorFilter(r3);	 Catch:{ IllegalStateException -> 0x0067 }
        r1 = android.support.v4.view.ViewCompat.getLayerType(r7);	 Catch:{ IllegalStateException -> 0x0067 }
        if (r1 == r5) goto L_0x0040;
    L_0x003a:
        r1 = 2;
        r2 = r0.dimPaint;	 Catch:{ IllegalStateException -> 0x0067 }
        android.support.v4.view.ViewCompat.setLayerType(r7, r1, r2);	 Catch:{ IllegalStateException -> 0x0067 }
    L_0x0040:
        r6.invalidateChildRegion(r7);	 Catch:{ IllegalStateException -> 0x0069 }
        r1 = a;	 Catch:{ IllegalStateException -> 0x0069 }
        if (r1 == 0) goto L_0x0064;
    L_0x0047:
        r1 = android.support.v4.view.ViewCompat.getLayerType(r7);	 Catch:{ IllegalStateException -> 0x006b }
        if (r1 == 0) goto L_0x0064;
    L_0x004d:
        r1 = r0.dimPaint;	 Catch:{ IllegalStateException -> 0x006d }
        if (r1 == 0) goto L_0x0057;
    L_0x0051:
        r0 = r0.dimPaint;	 Catch:{ IllegalStateException -> 0x006d }
        r1 = 0;
        r0.setColorFilter(r1);	 Catch:{ IllegalStateException -> 0x006d }
    L_0x0057:
        r0 = new android.support.v4.widget.SlidingPaneLayout$DisableLayerRunnable;
        r0.<init>(r6, r7);
        r1 = r6.mPostedRunnables;
        r1.add(r0);
        android.support.v4.view.ViewCompat.postOnAnimation(r6, r0);
    L_0x0064:
        return;
    L_0x0065:
        r0 = move-exception;
    ...
    L_0x006d:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.widget.SlidingPaneLayout.dimChildView(android.view.View, float, int):void");
    }
    ...
    L_0x000d:
        ...
        r0 = a;	 Catch:{ IllegalStateException -> 0x001e }
