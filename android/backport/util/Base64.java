...
*/
    ...
    public static String encodeToString(byte[] bArr, int i) {
        try {
            return new String(encode(bArr, i), z[0]);
...
*/
    ...
    L_0x002a:
        r5[r3] = r2;
        z = r6;
        r0 = android.backport.util.Base64.class;	 Catch:{ IllegalArgumentException -> 0x0055 }
        r0 = r0.desiredAssertionStatus();	 Catch:{ IllegalArgumentException -> 0x0055 }
        if (r0 != 0) goto L_0x0057;
    L_0x0036:
        $assertionsDisabled = r4;
        return;
    L_0x0039:
        r10 = r7[r9];
        r2 = r9 % 5;
    ...
    L_0x0057:
        ...
        goto L_0x0036;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.backport.util.Base64.<clinit>():void");
    }
