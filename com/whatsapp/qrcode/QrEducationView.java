...
public class QrEducationView extends View {
    ...
    public void onDraw(android.graphics.Canvas r22) {
        /*
        r21_this = this;
        r7 = com.whatsapp.qrcode.QrCodeActivity.t;
        r8 = r21.getWidth();
        r9 = r21.getHeight();
    ...
    L_0x03e8:
        r2 = 0;
    L_0x03e9:
        com.whatsapp.qrcode.QrCodeActivity.t = r2;
    L_0x03eb:
        return;
    L_0x03ec:
        r2 = 1;
    ...
    private static float a(float f, float f2, float f3) {
        ...
        return f3 >= f2 ? 1.0f : (f3 - f) / (f2 - f);
    }

    protected void onAttachedToWindow() {
        super.onAttachedToWindow();
        this.h = new d(this, null);
        this.h.setDuration(8000);
    ...
    private void a(Context context) {
        ...
        this.s = resources.getDrawable(R.drawable.anim_qr_normal);
        this.k = resources.getDrawable(R.drawable.anim_qr_blurred);
        this.r = resources.getDrawable(R.drawable.anim_laptop);
        this.q = resources.getDrawable(R.drawable.anim_phone);
        this.l = resources.getDrawable(R.drawable.anim_frame);
        this.b = resources.getDrawable(R.drawable.anim_check);
    }
