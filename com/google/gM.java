...
public final class gm extends g3 {
    private C e;
    ...
    L_0x0045:
        ...
        goto L_0x0008;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gm.c():com.google.C");
    }
    ...
    private static void a(byte[] bArr, int i, int i2, int i3, int i4, C c) {
        boolean z = da.b;
        int i5 = (i2 * i4) + i;
        int i6 = 0;
        while (i6 < 8) {
    ...
    L_0x00c2:
        ...
        goto L_0x0018;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gm.a(byte[], int, int, int, int):int[][]");
    }

    private static void a(byte[] bArr, int i, int i2, int i3, int i4, int[][] iArr, C c) {
        boolean z = da.b;
        int i5 = 0;
        while (i5 < i2) {
            int i6 = i5 << 3;
