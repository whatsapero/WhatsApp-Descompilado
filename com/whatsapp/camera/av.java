...
class av implements TextWatcher {
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        b7.a(CameraActivity.a(this.a), charSequence);
    }
    ...
    L_0x008a:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.camera.av.afterTextChanged(android.text.Editable):void");
    }

    av(CameraActivity cameraActivity, TextView textView) {
